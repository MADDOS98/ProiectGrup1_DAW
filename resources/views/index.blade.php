...
<head>
    ...
    <style>
        ...
        /* Task finalizat */
        .task-completed {
            border: 2px solid #0b1a2f !important;
        }
    ...
    <div class="container py-4">
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-12 col-md-6 col-lg-3 d-flex align-items-stretch">
                <div class="card task-card w-100 p-3 @if($task->stare == 'Anulata') task-cancelled @elseif($task->stare == 'Finalizata') task-completed @endif ">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <span class="badge">#{{ $task->id }}</span>
                        <span class="badge @if($task->stare == 'Anulata') badge-cancelled @elseif($task->stare == 'Finalizata') badge-completed @endif ">
                            {{ ucfirst($task->stare) }}
                        </span>
                    </div>
